...
open class FPNTextField: UITextField {
    ...
    open var countryCodeButton: UIButton = UIButton()
    ...
    private func setupCountryButton() {
        countryCodeButton.addTarget(self, action: #selector(displayCountries), for: .touchUpInside)
    ...
    private func setupLeftView() {
        ...
        NSLayoutConstraint(item: countryCodeButton, attribute: .leading, relatedBy: .equal, toItem: flagButton, attribute: .trailing, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: countryCodeButton, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: countryCodeButton, attribute: .top, relatedBy: .equal, toItem: leftView, attribute: .top, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: countryCodeButton, attribute: .bottom, relatedBy: .equal, toItem: leftView, attribute: .bottom, multiplier: 1, constant: 0).isActive = true
    }
